            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (empty($user)) { ?>
                            <li><a class="dropdown-item" href="<?php echo $baseUrl ?>?page=login">
                            ...
                            <li><a class="dropdown-item" href="<?php echo $baseUrl ?>?page=register">
                                    ...
                                    Register</a></li>
                        <?php } else { ?>
                            <li><a class="dropdown-item" href="<?php echo $baseUrl ?>?page=profile">
                            ...
                            <li><a class="dropdown-item" href="<?php echo $baseUrl ?>?page=logout">
